...
public class BuscarCodLibro extends javax.swing.JFrame {
    MantenimientoBB MBB;
    
    public BuscarCodLibro(MantenimientoBB MBB) {
        initComponents();
        ...
        tabla.setModel(DBAdmin.obtenerRegistrosLibro((DefaultTableModel)tabla.getModel()));
    }
    ...
    private void initComponents() {
        ...
        cbx_criterio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Título", "Autor", "Materia" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tbx_frase, javax.swing.GroupLayout.PREFERRED_SIZE, 376, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_enviarActionPerformed
        ...
        if(fila >= 0){
            //el lbl_codigo_libro es un componente public static para poderse llamar
            MantenimientoBB.lbl_codigo_libro.setText(tabla.getValueAt(fila,0).toString());
            MBB.setEnabled(true); //habilita la ventana MantenimientoBB
            dispose();
        }else{
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ...
        if(!frase.isEmpty()){
            ...
            limpiarTabla();
            //llena la tabla con los registros existentes
            tabla.setModel(DBAdmin.obtenerRegistrosLibro((DefaultTableModel)tabla.getModel(),frase,cbx_criterio.getSelectedIndex()));
        }else{
            getToolkit().beep(); //hace un beep
